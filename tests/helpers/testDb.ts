...
export async function createTestDb(): Promise<any> {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS sale_payments (id INTEGER PRIMARY KEY AUTOINCREMENT, saleId INTEGER NOT NULL, method TEXT NOT NULL, amount REAL NOT NULL DEFAULT 0, createdAt TEXT NOT NULL DEFAULT '');
    ...
    CREATE TABLE IF NOT EXISTS cross_sell_rule_items (id INTEGER PRIMARY KEY AUTOINCREMENT, ruleId INTEGER NOT NULL, productId INTEGER NOT NULL, quantity INTEGER NOT NULL DEFAULT 1, discountPercent REAL DEFAULT 0);
    ...
    CREATE TABLE IF NOT EXISTS installment_payments (id INTEGER PRIMARY KEY AUTOINCREMENT, installmentId INTEGER NOT NULL, installmentNumber INTEGER NOT NULL, amount REAL NOT NULL DEFAULT 0, dueDate TEXT NOT NULL, paidDate TEXT DEFAULT NULL, penaltyAmount REAL DEFAULT 0, status TEXT NOT NULL DEFAULT 'pending', notes TEXT DEFAULT '', createdAt TEXT NOT NULL DEFAULT '');
    ...
    CREATE TABLE IF NOT EXISTS proforma_items (id INTEGER PRIMARY KEY AUTOINCREMENT, proformaId INTEGER NOT NULL, productId INTEGER NOT NULL, productTitle TEXT NOT NULL, quantity REAL NOT NULL, unitPrice REAL NOT NULL, subtotal REAL NOT NULL);
    ...
    CREATE TABLE IF NOT EXISTS suppliers (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, phone TEXT DEFAULT '', email TEXT DEFAULT '', address TEXT DEFAULT '', company TEXT DEFAULT '', taxId TEXT DEFAULT '', notes TEXT DEFAULT '', balance REAL DEFAULT 0, description TEXT DEFAULT '', isActive INTEGER NOT NULL DEFAULT 1, createdAt TEXT NOT NULL DEFAULT '');
